...
class Cell(object):
    ...
    displaySets = {'basic': {'liveChar': 'O', 'deadChar': '.'},
                    ...
                    'smily' : {'liveChar': '\U0001F90D','deadChar': '\U0001F480'},
                    'boney' : {'liveChar': '\u2688','deadChar': '\U0001F9B4'},
                    'king' : {'liveChar': '\u265B','deadChar': '\u2687'},
                    'star' : {'liveChar': '\u26CA','deadChar': '\u2606'}}
    ...
    def set_living(self, state):
        ...
        :param state: Whether or not the cell is living or dead.
        :return: None
        """
    ...
    def add_neighbor(self, cell):
        """
        Adds the cells to the neighbors list.
        :param cell: Is basically one single cell int he whole grid.
        :return: None
        """
        #
    ...
    def living_neighbors(self):
        """
        Goes through all the neighbors and if they are living will make them living.
